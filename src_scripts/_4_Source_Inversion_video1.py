...
np.savez_compressed(f"{HOMEDIR}/Generated_data/video1/cortical_surface_related/parcellated_widerband", parcellated=list(parcellated.values()))
...
np.savez_compressed(f'{HOMEDIR}/Generated_data/video1/cortical_surface_related/wideband_bandpassed', **wideband_data)
