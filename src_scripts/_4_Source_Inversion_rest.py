...
np.savez_compressed(f"{HOMEDIR}/Generated_data/rest/cortical_surface_related/parcellated_widerband", parcellated=list(parcellated.values()))
...
np.savez_compressed(f'{HOMEDIR}/Generated_data/rest/cortical_surface_related/wideband_bandpassed', **wideband_data)
