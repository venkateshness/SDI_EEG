...
subjects = sorted(list(os.listdir(f'{HOMEDIR}/Generated_data/video2/preprocessed_dataset/')))

n_chans_after_preprocessing = 91
time_in_samples = 162 * 125
...
for id in range(len(subjects)): 
    ...
    data_video, events_list = (
        mne.io.read_raw_fif(
            f"{HOMEDIR}/Generated_data/video2/preprocessed_dataset/{subjects[id]}/raw.fif",
            verbose=False,
        ),
        np.load(
            f"{HOMEDIR}/Generated_data/video2/preprocessed_dataset/{subjects[id]}/events.npz"
