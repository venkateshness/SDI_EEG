...
for i in range(1, len(subject_list) + 1):
    if os.path.exists(f"{HOMEDIR}/src_data/video1/{subject_list[i-1]}/") and os.path.exists(f"{HOMEDIR}/src_data/rest/{subject_list[i-1]}/"):
        ...
        if not os.path.exists(
            f"{HOMEDIR}/Generated_data/rest/preprocessed_dataset/{subject_list[i-1]}"
        ):
            os.makedirs(
                f"{HOMEDIR}/Generated_data/rest/preprocessed_dataset/{subject_list[i-1]}"
            )
        ...
        resting_state_raw.save(
            f"{HOMEDIR}/Generated_data/rest/preprocessed_dataset/{subject_list[i-1]}/raw.fif",
            overwrite=True,
        )
        np.savez_compressed(
            f"{HOMEDIR}/Generated_data/rest/preprocessed_dataset/{subject_list[i-1]}/events.npz",
...
for i in range(1, len(subject_list) + 1):
    ...
    if os.path.exists(f"{HOMEDIR}/src_data/video1/{subject_list[i-1]}/") and os.path.exists(f"{HOMEDIR}/src_data/rest/{subject_list[i-1]}/"):
        ...
        if not os.path.exists(
            f"{HOMEDIR}/Generated_data/video1/preprocessed_dataset/{subject_list[i-1]}"
        ):
            os.makedirs(
                f"{HOMEDIR}/Generated_data/video1/preprocessed_dataset/{subject_list[i-1]}"
            )
