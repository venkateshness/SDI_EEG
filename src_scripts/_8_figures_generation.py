...
for band in [ 'widerband']:#'theta', 'alpha', 'low_beta', 'high_beta', 'gamma', 'wideband',
    video_watching_SDI=np.log2(np.load(f"{HOMEDIR}/revision/Generated_data_revision/video1/Graph_SDI_related/empirical_SDI.npz")[f'{band}'])
    rs_SDI = np.log2(np.load(f"{HOMEDIR}/revision/Generated_data_revision/rest/Graph_SDI_related/empirical_SDI.npz")[f'{band}'])
...
# np.savez_compressed(f"{HOMEDIR}/revision/Generated_data_revision/Data_for_plots/SDI_corrected_movie_vs_rest_{band}.npz", **SDI_corrected_movie_vs_rest_all_band)
...
for band in ['widerband']:
    video_watching_SDI=np.log2(np.load(f"{HOMEDIR}/revision/Generated_data_revision/video2/Graph_SDI_related/empirical_SDI.npz")[f'{band}'])
    rs_SDI = np.log2(np.load(f"{HOMEDIR}/revision/Generated_data_revision/rest/Graph_SDI_related/empirical_SDI.npz")[f'{band}'])
    ...
    # np.savez_compressed(f"{HOMEDIR}/revision/Generated_data_revision/Data_for_plots/SDI_corrected_anvideo_vs_rest_{band}.npz", widerband=SDI_corrected_anvideo_vs_rest)
